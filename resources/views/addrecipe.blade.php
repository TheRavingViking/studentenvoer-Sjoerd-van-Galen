            ...
            <div class="row">
                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                    <form enctype="multipart/form-data" class="form-horizontal" method="POST" action="/">
                        ...
                        <div>
                            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                <input id="Ingredient" name="ingredient" type="text" class="form-control" placeholder="Ingredient"><br>
                            </div>
                            <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                                <input id="amount" name="amount" type="text" class="form-control" placeholder="Amount"><br>
                            </div>
                            <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
