                            ...
                            <div class="panel panel-default">
                                ...
                                <div style="padding: 1em">
                                    <input id="likes" name="" type="text" class="rating rating-loading" data-size="sm"
                                           value="{{round($breakfast->Ratings->avg('rating'))}}" disabled>
                                    <button class="btn btn-default">
                    ...
                    @foreach($lunches as $lunch)
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            <div class="panel panel-default">
                                ...
                                <div style="padding: 1em">
                                    <input id="likes" name="" type="text" class="rating rating-loading" data-size="sm"
                                           value="{{round($lunch->Ratings->avg('rating'))}}" disabled>
                                    <button class="btn btn-default">
                    ...
                    @foreach($dinners as $dinner)
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            <div class="panel panel-default">
                                ...
                                <div style="padding: 1em">
                                    <input id="likes" name="" type="text" class="rating rating-loading" data-size="sm"
                                           value="{{round($dinner->Ratings->avg('rating'))}}" disabled>
                                    <button class="btn btn-default">
                    ...
                    @foreach($desserts as $dessert)
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            <div class="panel panel-default">
                                ...
                                <div style="padding: 1em">
                                    <input id="likes" name="" type="text" class="rating rating-loading" data-size="sm"
                                           value="{{round($dessert->Ratings->avg('rating'))}}" disabled>
                                    <button class="btn btn-default">
